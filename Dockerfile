...
RUN echo '{ "root_node_ips": [{"Ip": "20.188.6.225"},{"Ip": "74.226.182.22"},{"Ip": "57.182.103.24"}], "try_new_peers": false, "chain": "Mainnet" }' > /home/$USERNAME/override_gossip_config.json
...
ENTRYPOINT ["sh", "-c", "RUST_LOG=debug /home/hluser/hl-visor", "run-non-validator", "--replica-cmds-style", "recent-actions"]
